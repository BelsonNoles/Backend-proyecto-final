...
import com.portfolio.BackEndportf.Dto.dtoExperiencia;
import com.portfolio.BackEndportf.Entity.Experiencia;
import com.portfolio.BackEndportf.Security.Controller.Mensaje;
import com.portfolio.BackEndportf.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
        if(!sExperiencia.existsById(id))
            return new ResponseEntity(new Mensaje("El id de la experiencia no existe"), HttpStatus.BAD_REQUEST);
