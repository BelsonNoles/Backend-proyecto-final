...
import com.portfolio.BackEndportf.Dto.dtoEducacion;
import com.portfolio.BackEndportf.Entity.Educacion;
import com.portfolio.BackEndportf.Security.Controller.Mensaje;
import com.portfolio.BackEndportf.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        if(!sEducacion.existsById(id)){
            return new ResponseEntity(new Mensaje("El id de la educacion no existe"), HttpStatus.NOT_FOUND);
        }
